...
| `module_types`, `module_recipe_ingredients` | **Modules** (catalog/config — seeded by migration only, NO runtime writer yet; the mint writer arrives with `module_instances` in a later Phase-13 slice) | public read-only |
