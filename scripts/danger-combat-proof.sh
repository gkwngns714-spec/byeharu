...
if [ "$MODE" = "selftest" ]; then
  ...
  if command -v node >/dev/null 2>&1; then
    for gen in gen-0305-sortie-authority gen-0306-dock-authority gen-0308-combat-roster-authority gen-0310-hp-auto-exit gen-0312-no-living-ships; do
