...
//     targets this ship directly, no <select>. ENABLED only when the ship's place is
//     docked/berthed (fittingEditability over the SAME positions row — never a 2nd dockedness
//     query); the server's 0114 settled-safe rule stays the enforcer and its ship_not_settled
//     copy surfaces verbatim on a reject.
  ...
  return (
    <Card tone="accent" data-testid="fitting-detail">
      ...
      {/* ── THE FITTING SURFACE — the ONE fit/unfit edit surface in the app (Workshop rows retired
          ...
          positions row (docked/berthed) — the server's 0114 settled-safe rule stays the enforcer. */}
      {litFittings && (
        <>
