...
import { PageHeader, Notice, Screen, Skeleton, buttonClasses } from '../../components/ui'
  ...
  return (
    <Screen>
      ...
      {game.loading && !game.base ? (
        // First-load placeholder (panel-shaped skeletons; sr-only status for screen readers).
