...
begin
    ...
    (3, 'process_combat_ticks',
     $h3o$              -- ██ 0336 THE WAVE SPAWNS ON A RING, NOT ON ONE POINT ██
              ...
              for v_spawn_i in 1 .. v_enemy_count loop
                -- ██ 0338 THE WAVE ARRIVES FROM THE ZONE'S OWN CITY ██
                ...
                select fp.x, fp.y into v_slot_x, v_slot_y
                  from public.combat_formation_point(v_anchor_x, v_anchor_y, v_formation_extent + v_enemy_range + 1, v_spawn_slot,
                         public.combat_wave_arrival_phase(v_anchor_x, v_anchor_y, loc.x, loc.y, v_spawn_slot)) fp;
  ...
  v_spawn_slot             integer;$h5n$),
    ...
    (7, 'process_combat_ticks',
     $h7o$        -- THE SAME TWO CONDITIONS THE ORDER ARM ADMITTED ON, ASKED AGAIN AT THE MOMENT OF MOVING.
          ...
          if v_rp_speed is not null and v_rp_speed > 0 then
            ...
            update combat_encounters
               set engagement_x = v_rp_tx,
                   ...
                   updated_at   = now()
             where id = e.id;$h7o$,
     $h7n$        -- THE SAME CONDITIONS THE ORDER ARM ADMITTED ON, ASKED AGAIN AT THE MOMENT OF MOVING.
