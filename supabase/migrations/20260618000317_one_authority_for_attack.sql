...
begin
  ...
  v_hull_cur        double precision;$h10n$),
    ...
    (12, 'combat_create_group_encounter',
     $h12o$    v_attack := 0; v_defense := 0; v_hp := 0; v_alive := 0;
    ...
    v_hp_max := m.max_hp;$h12n$),
    (13, 'combat_create_group_encounter',
     $h13o$    v_roster := v_roster || jsonb_build_array(jsonb_build_object(
      ...
      'pos_x', v_pos_x, 'pos_y', v_pos_y, 'move_speed', v_move_speed, 'weapons_json', v_weapons_json));$h13o$,
     $h13n$    v_roster := v_roster || jsonb_build_array(jsonb_build_object(
      'main_ship_id', m.main_ship_id, 'player_id', m.player_id, 'hp', v_hp, 'hp_max', v_hp_max,
      'alive', v_alive, 'attack', v_attack, 'defense', v_defense,
      'shield_max', v_shield_max, 'shield_cur', v_shield_cur,
      'aggro_priority', v_aggro_priority,
      'pos_x', v_pos_x, 'pos_y', v_pos_y, 'move_speed', v_move_speed, 'weapons_json', v_weapons_json));$h13n$),
    (14, 'combat_create_group_encounter',
     $h14o$         (e->>'hp')::double precision, 1, (e->>'alive')::integer,
         (e->>'hp')::double precision, (e->>'hp')::double precision,$h14o$,
     $h14n$         (e->>'hp')::double precision, 1, (e->>'alive')::integer,
         (e->>'hp_max')::double precision, (e->>'hp')::double precision,$h14n$),
