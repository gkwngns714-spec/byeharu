...
begin
  for r in
    ...
    (1, 'process_combat_ticks',
     $h1o$          -- Retreating player ships hold position and cease fire (the v_offense gate, mirrored — the
     ...
     $h1n$          -- 0317 THE DEAD DO NOT ACT. v_units is frozen ABOVE, before any movement, deliberately:
